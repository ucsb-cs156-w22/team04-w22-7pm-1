...
describe("AppNavbar tests", () => {
  ...
  test("renders the personalSchedule menu correctly for a user", async () => {
    const currentUser = currentUserFixtures.userOnly;
    const systemInfo = systemInfoFixtures.showingBoth;
    ...
    await waitFor(() =>
      expect(getByTestId("appnavbar-personalSchedule-dropdown")).toBeInTheDocument()
    );
    const dropdown = getByTestId("appnavbar-personalSchedule-dropdown");
  ...
  test("renders the search correctly for a user", async () => {
    const currentUser = currentUserFixtures.userOnly;
    const systemInfo = systemInfoFixtures.showingBoth;
    ...
    await waitFor(() =>
      expect(getByTestId("appnavbar-basicsearch-dropdown")).toBeInTheDocument()
    );
    const dropdown = getByTestId("appnavbar-basicsearch-dropdown");
    const aElement = dropdown.querySelector("a");
    expect(aElement).toBeInTheDocument();
    aElement?.click();
    await waitFor(() => expect(getByTestId("appnavbar-basicsearch-dropdown")).toBeInTheDocument());
  });
  ...
  test("renders the personalSchedule menu correctly for an admin", async () => {
    ...
    aElement?.click();
    await waitFor(() =>
      expect(getByTestId(/appnavbar-personalSchedule-create/)).toBeInTheDocument()
    );
  });
});
